...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">blogpessoalf documentation</a>
                </li>
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link" >AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-04f24a0706b93496b23bc64a46fcf091"' : 'data-target="#xs-components-links-module-AppModule-04f24a0706b93496b23bc64a46fcf091"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-04f24a0706b93496b23bc64a46fcf091"' :
                                            'id="xs-components-links-module-AppModule-04f24a0706b93496b23bc64a46fcf091"' }>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/LogarComponent.html" data-type="entity-link" data-context="sub-entity" data-context-id="modules" >LogarComponent</a>
                                            </li>
                                            <li class="link">
